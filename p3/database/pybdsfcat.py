"""pybdsf_source.py contains the function read_catalog which 
reads in a source list text file of the kind generated by PyBDSF's 
write_catalog() function and stores each line (source) in a list of 
objects defined by the class DetectedSource in database.dbclasses."""
